...
// Integer formats
GVOX_CONSTANT(GVOX_FORMAT_R8_UINT, GVOX_CREATE_FORMAT(GVOX_FORMAT_ENCODING_LINEAR, 1, 8, 0, 0, 0))
GVOX_CONSTANT(GVOX_FORMAT_R16_UINT, GVOX_CREATE_FORMAT(GVOX_FORMAT_ENCODING_LINEAR, 1, 16, 0, 0, 0))
GVOX_CONSTANT(GVOX_FORMAT_R32_UINT, GVOX_CREATE_FORMAT(GVOX_FORMAT_ENCODING_LINEAR, 1, 32, 0, 0, 0))
...
GvoxResult GVOX_EXPORT gvox_create_voxel_desc(GvoxVoxelDescCreateInfo const *info, GvoxVoxelDesc *handle) GVOX_FUNC_ATTRIB;
void GVOX_EXPORT gvox_destroy_voxel_desc(GvoxVoxelDesc handle) GVOX_FUNC_ATTRIB;

size_t GVOX_EXPORT gvox_voxel_desc_size_in_bits(GvoxVoxelDesc handle) GVOX_FUNC_ATTRIB;
size_t GVOX_EXPORT gvox_voxel_desc_attribute_count(GvoxVoxelDesc handle) GVOX_FUNC_ATTRIB;
#ifdef __cplusplus
}
#endif
