...
extern "C" auto gvox_parse_adapter_test_query_region_flags([[maybe_unused]] GVoxAdapterContext *ctx, [[maybe_unused]] GVoxRegionRange const *range) -> uint32_t {
    return GVOX_REGION_FLAG_UNIFORM;
}

extern "C" void gvox_parse_adapter_test_load_region(GVoxAdapterContext *ctx, [[maybe_unused]] GVoxOffset3D const *offset) {
...
extern "C" auto gvox_parse_adapter_test_sample_data([[maybe_unused]] GVoxAdapterContext *ctx, GVoxRegion const *region, [[maybe_unused]] GVoxOffset3D const *offset) -> uint32_t {
