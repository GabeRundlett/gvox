...
void test_raw_file_io(void) {
    ...
    // Create gvox_raw file
    {
        ...
        gvox_translate_region(adapter_ctx, &region_range, GVOX_CHANNEL_BIT_COLOR | GVOX_CHANNEL_BIT_NORMAL);
...
void test_palette_file_io(void) {
    ...
    // Create gvox_palette file
    {
        ...
        gvox_translate_region(adapter_ctx, &region_range, GVOX_CHANNEL_BIT_COLOR);
        gvox_destroy_adapter_context(adapter_ctx);
    }
