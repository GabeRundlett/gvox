...
int main() {
...

    {
        ...
        parse_info.type = GVOX_TYPE_PARSE_INFO;
        parse_info.p_next = NULL;
        parse_info.container = png_container;
        parse_info.transform = transform;
        parse_info.range = NULL;
        parse_info.channel_flags = GVOX_CHANNEL_BIT_COLOR;

        gvox_load(gvox_ctx, parse_info);
    }
